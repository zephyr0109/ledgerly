...
def load_and_preprocess_debt_account(account_path: str) -> pd.DataFrame:
    """Load CSV file and preprocess it for database insertion."""
...
def load_and_preprocess_debt_snapshot(snapshot_path: str) -> pd.DataFrame:
    """Load CSV file and preprocess it for database insertion."""
